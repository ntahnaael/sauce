...
Your text goes here
\subsection{Skills for \majD: \studD}-Security Testing(TEST)\cite{n1}
...
\textbf{Skill 2-SFIA}-Penetration Testing(PENT)\cite{n2}
...
\textbf{Skill 3-SFIA}-Strategic Planning(ITSP)\cite{n3}
