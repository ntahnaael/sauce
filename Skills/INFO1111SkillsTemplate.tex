...
\newcommand{\studA}{{WRIGHT, Sophie}}
\newcommand{\studB}{{JAITLY, Aditya}}
\newcommand{\studC}{{MCGLENNON, Lachlan}}
\newcommand{\studD}{{FAMNAME4, givenName4}}
%
% IMPORTANT - Then give your SIDs
\newcommand{\sidA}{{01234567}}
\newcommand{\sidB}{{530310709}}
...
\textbf{Screenshots of evidence}:
Cloning the repo:
\includegraphics[]{/Users/Sophie/Desktop/clone_sw.png}
Retrieving the repo:
\includegraphics[]{/Users/Sophie/Desktop/retrieve_repo_sw.png}
Making changes to the LaTeX document:
\includegraphics[]{/Users/Sophie/Desktop/make_changes_sw.png}
Recompiling te document:
\includegraphics[]{/Users/Sophie/Desktop/recompile_sw.png}
Committing changes, pushing back:
\includegraphics[]{/Users/Sophie/Desktop/commit_push_sw.png}

\subsection{Skills for \majB: \studB}
\section{OK RATING}\\

\textbf{Skill 1-SFIA}-Data Management(DATM)\cite{sfiads}

In the field of Data Science, Data Management stands out as one of the most crucial skills. Given that Data Science revolves around handling vast amounts of data, mastering Data Management becomes essential. This skill forms the backbone for making the most out of data by ensuring it's well-organized, analyzed effectively, and utilized for making informed decisions.

Data analysts primarily focus on understanding information structures and finding innovative ways to handle organizational data assets.

Furthermore, ethical considerations are predominant in any profession, including Data Science. Therefore, it's necessary to adhere to ethical principles when dealing with data, ensuring privacy, integrity, and responsible data handling practices are maintained at all times.In essence,data management is a skill that includes various tasks ranging from collecting,storing,organizing,analyzing and maintaining data in order to maintain accuracy,security,integrity and accessibility to data\cite{sfia1}.

\textbf{Skill 2-SFIA}-Database Design(DBDS)\cite{sfiads}

Proficiency in Database Management Systems (DBMS) like MySQL,PostgreSQL,etc is highly valued in Data Science due to its widespread use.Data Scientists have to deal with large data in the form of tables(relations) and DBMS are used to retrieve, update and do other operations on the data.Therefore,DBDS is critical for structuring and maintaining mechanisms for storing and accessing data efficiently.

Database design is also used for defining data warehouse structures required to support machine learning, business intelligence or data analytics services\cite{sfia2}.
...
\includegraphics[width=17cm]{Skills screenshot/Created repo.png}
...
\includegraphics[width=19cm]{Skills screenshot/git add and commit.png}
\label{fig: git add and commit}

\includegraphics[width=21cm]{Skills screenshot/git push.png}
\label{fig: git add and commit}

\textbf{Compilation from the terminal:}\\

\includegraphics[width=18cm]{Skills screenshot/pdflatex.png}
...
\includegraphics[width=19cm]{Skills screenshot/git pull.png}

\textbf{Make changes,recompile,commit changes and push back to the Repository:}

\includegraphics[width=21cm]{Skills screenshot/Strong repushed the file.png}\\

\includegraphics[width=17cm]{Skills screenshot/Strong recompile.png}

\newpage
\subsection{Skills for \majC: \studC}
\textbf{Skill 1-SFIA}-Testing(TEST)\cite{sfiads}

Testing, for software development majors, is a skill more important then knowing how to design software. Without testing software serves no purpose after all. Working in software development requires hard testing skills such as how to unit test code, how to capture behavior in tests and how to use external testing tools and automate testing. \cite{test} Additionally majors need to understand the testing frameworks they will use, waterfall, agile. \cite{test} . Testing involves designing software that can be easily tested, designing tests which give meaningful information about software and using appropriate testing tools and technology for that purpose.

\textbf{Skill 2-SFIA}-Programming/Software Development (PROG)\cite{sfiads}

Software development is at its core about creating software to meet expectations, so being able to design and develop software is key. This skill is not just about writing good code though, software development is a team effort, skills such as code readability, code review and design communication are the standard. \cite{prog} Software development majors need to be able to create code understandable and justifiable to their peers. They need to be able to understand others designs and be able to discuss and improve them. \cite{prog} They need to be able to express how their design solution is the best to fit requirements of the client. \cite{prog}
\textbf{Skill 3-SFIA}-Release and Deployment(RELM)\cite{sfiads}
Release and deployment is a important skill for software development majors to have. This skill involves being able to understand how software is deployed and the different procedures required to successfully deploy it.\cite{relm} It also involves understanding the tools integral to this process such as automated testing, and development pipelines. \cite{relm} Given that software developers develop software to use, understanding how the software is put into production and how to update and manage production software is important. 
\newpage
\textbf{Proof of work}
I have cloned the repo
\includegraphics[]{lachlan_ss/Lachlan_clone.png}\\
I can compile it
\includegraphics[]{lachlan_ss/Lachlan_recompile.png}\\
I can Commit changes
\includegraphics[]{lachlan_ss/Lachlan_commit.png}\\
\section{STRONG RATING}\\
I can pull changes
\includegraphics[]{lachlan_ss/Lachlan_pull.png}\\
I can push and recompile changes
\includegraphics[]{lachlan_ss/Lachlan_push.png}\\
...
Our team began establishing our responsibilities for which major we were to choose, and when to get it done by. Whilst we researched our skills for each major individually, we chose to communicate on a Discord server if we had any issues with understanding what the foundation task entailed. The majority of the communication and queries occurred in the compiling stage of the document to verify whether the texfile was being compiled correctly from our terminal through to GitHub. 
