...
\includegraphics[width=17cm]{Created repo.png}
...
\includegraphics[width=19cm]{git add and commit.png}
\label{fig: git add and commit}

\includegraphics[width=21cm]{git push.png}
\label{fig: git add and commit}

\textbf{Compilation from the terminal:}

\includegraphics[width=18cm]{pdflatex.png}
