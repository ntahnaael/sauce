...
At the core of the computer science industry is the study of computational skills and dealing with software systems, thus PROG is a key skill which applies fundamental computational theories such as algorithms and data structures to the design, creation and testing of software solutions [6]. Programming allows the optimisation of tasks in computer science through automated analysis of data [2] and user-interactive interfaces which boost efficiency of decision-making processes. Given the fast-pace evolution of software it additionally instills a mindset adaptable to problem-solving in order to address emerging digital challenges [1].

\textbf{Skill 2-SFIA}- Informtion Systems Coordination (ISCO):

ISCO, the coordination of information and technology strategies is important to maintaining the lifecycle of an effective computing system [5]. This involves the delegation of work across various computing domains and collaboration between interdisciplinary fields, crucial to the incentive in computer science of solving real-world problems in an adaptable manner. The calibre of efficiency in the management of data, the optimisation of resources [3] (whether that be hardware or software) and the collaboration of a team is also heavily dependent on the organisational nature of ISCO, governing how seamlessly the computer system functions.

\textbf{Skill 3-SFIA}- Quality Assurance (QUA):

Through periodic assessments and documentation [7] of  a system’s proficiency, quality assurance is a skill ensuring an organisation’s standards of quality are met [7] before operations are executed to stakeholders. Ensuring a computing system can reliably operate under specified conditions without failure is crucial to apt user experience and the management of sensitive information. As computer science emphasises continuous improvement of a developing system, QUAS enables one to observe improvement opportunities of defects [4], what is already proficient in its features as well as implications of emerging technology [7].

\textbf{Screenshots of evidence):
\includegraphics[]{/Users/Sophie/Desktop/Screen Shot 2024-03-27 at 10.21.21 am.png}
\includegraphics[]{/Users/Sophie/Desktop/Screen Shot 2024-03-27 at 11.01.33 am.png}
\includegraphics[]{/Users/Sophie/Desktop/Screen Shot 2024-03-27 at 1.46.21 pm.png}
\includegraphics[]{/Users/Sophie/Desktop/Screen Shot 2024-03-27 at 3.56.49 pm.png}


\subsection{Skills for \majB: \studB}

\textbf{Skill 1-SFIA}-Data Management(DATM)

In the field of Data Science, Data Management stands out as one of the most crucial skills. Given that Data Science revolves around handling vast amounts of data, mastering Data Management becomes essential. This skill forms the bedrock for making the most out of data by ensuring it's well-organized, analyzed effectively, and utilized for making informed decisions.
...
Furthermore, ethical considerations are paramount in any profession, including Data Science. Therefore, it's necessary to adhere to ethical principles when dealing with data, ensuring privacy, integrity, and responsible data handling practices are maintained at all times. In essence, Data Management is not just about managing data; it's about unlocking its full potential while upholding ethical standards, making it a cornerstone skill in Data Science.

\textbf{Skill 2-SFIA}-Database Design(DBDS)
...
Database design is also used for defining data warehouse structures required to support machine learning, business intelligence or data analytics services.
...
\textbf{Skill 3-SFIA}-Data visualisation(VISL)
Data visualization is a critical aspect of data science because it allows data scientists to present complex data in an easily understandable and digestible format.By condensing and encapsulating data characteristics, visualization enables practitioners to identify patterns, trends, opportunities, and risks efficiently.Good Visual interpretations not only simplifies the understanding of complex datasets but also allows decision-makers to make informed and timely decisions. 

Meaningful and engaging visualisations also attracts the human view and increases their interest in the representation and the whole topic.Therefore,Data visualisation involves presenting findings and insights creatively to cater to both technical and non-technical audiences.
